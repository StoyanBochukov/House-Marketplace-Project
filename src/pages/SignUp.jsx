    ...
    <>
      <div className="pageContainer">
        ...
        <main>
          ...
          <input type="text" className="nameInput" placeholder='First Name' id='fname'
             value={fname} onChange={onChange}/>

          <input type="text" className="nameInput" placeholder='Last Name' id='lname'
             value={lname} onChange={onChange}/>
